  ...
  <div class="mb-3 meta-view-line">
    <div class="meta-view-box">
      ...
      <div class="player-indicator-name">
        ...
        <svg v-if="this.side === BoardSide.White" class="bi bi-person-fill" fill="currentColor" height="16"
             style="margin-left: 5px;" viewBox="0 0 16 16" width="16" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="player-indicator-name">
        ...
        <svg v-if="this.side === BoardSide.Black" class="bi bi-person-fill" fill="currentColor" height="16"
             style="margin-left: 5px;" viewBox="0 0 16 16" width="16" xmlns="http://www.w3.org/2000/svg">
          <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
        </svg>
      </div>
